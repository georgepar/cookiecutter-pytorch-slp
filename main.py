...
from {{cookiecutter.project_name}}.dataset import MyDataset
from {{cookiecutter.project_name}}.model import MyModel
...
def get_parser():
    # TODO: Add your model args to the CLI parser
    parser = ArgumentParser("{{cookiecutter.project_description}}")
...
def get_data():
    # TODO: Download and preprocess your data and put them in torch.utils.data.Datasets 
...
def get_lightning_module(config):
    # TODO: Define your model, optimizer, criterion etc
